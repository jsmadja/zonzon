...
public class CabinetTest {
    ...
    public void test() throws Exception {
        ...
        assertEquals(Lists.newArrayList("01/09/18", "01/09/18", "14/09/18", "25/09/18", "30/09/18", "01/10/18", "01/10/18"),
                FluentIterable.from(etatsMisEnExamenP1).transform(new Function<EtatMisEnExamen, String>() {
                    @Override
