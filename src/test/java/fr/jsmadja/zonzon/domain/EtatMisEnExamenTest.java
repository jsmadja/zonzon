...
public class EtatMisEnExamenTest {
    ...
    public void testDelai() {
        EtatMisEnExamen etat = new EtatMisEnExamen("5674", "Julien Bobby", Nature.Delictuelle, DateMidnight.parse("2018-01-01"), null, DateMidnight.parse("2018-04-01"));
        assertEquals(DateMidnight.parse("2018-05-01"), etat.getDateEcheanceMD());
